...
<head>
    ...
    <title>FieldRoots AGRI CO. | Products</title>
...
<body>
    ...
    <section class="page-header">
        <div class="page-header-container">
            <span class="section-tagline">OUR CATALOGUE</span>
            <p class="page-description">
                Certified, traceable, and fairly priced.
            </p>
        </div>
    </section>

    <!-- Search Box Container for Dynamic Product Filter -->
        ...
        <div class="products-grid">
            ...
            if ($result && $result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    $desc = !empty($row["description"]) ? htmlspecialchars($row["description"]) : "No detailed description available.";
                    ?>
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-footer">
                                <div class="price-wrapper">
                                    <span class="price">US$ <?php echo number_format($row["price"], 2); ?></span>
                                </div>
                                <a href="contact.html"><button class="btn btn-card-order">Order</button></a>
                            </div>
                        </div>
                    </div>
                    <?php
